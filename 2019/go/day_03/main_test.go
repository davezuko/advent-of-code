...
func TestWalk(t *testing.T) {
	...
	for i, coord := range got {
		if coord != want[i] {
			t.Fatalf("wrong coordinate at index %v: want: %v; got %v\n", i, want[i], coord)
		}
	}
}

func TestStar1Example1(t *testing.T) {
	wires := "R8,U5,L5,D3\nU7,R6,D4,L4"
	want := 6
	got := Star1(wires)
	if got != want {
...
func TestStar1Example2(t *testing.T) {
...
func TestStar1Example3(t *testing.T) {
...
func TestStar1Long(t *testing.T) {
	want := 399
	got := Star1(input)
	if got != want {
		t.Fatalf("want: %v; got: %v\n", want, got)
...
func TestStar2Example1(t *testing.T) {
	wires := "R8,U5,L5,D3\nU7,R6,D4,L4"
	want := 30
	got := Star2(wires)
	if got != want {
...
func TestStar2Long(t *testing.T) {
	want := 15678
	got := Star2(input)
	if got != want {
		t.Fatalf("want: %v; got: %v\n", want, got)
